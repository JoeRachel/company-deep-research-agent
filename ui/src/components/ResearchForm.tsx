        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative group">
              <label
                htmlFor="companyName"
                className="block text-xl font-medium text-gray-700 mb-2.5 transition-all duration-200 group-hover:text-gray-900 font-['DM_Sans']"
              >
            ...
            <div className="relative flex items-center justify-center py-3.5">
              {isResearching ? (
                <>
                  ...
                  <span className="text-base font-medium text-gray-900/90">深度搜索中...</span>
                </>
              ) : (
                <>
                  <Search className="-ml-1 mr-2 h-5 w-5 text-gray-900/90" />
                  <span className="text-base font-medium text-gray-900/90">开启深度搜索</span>
                </>
              )}
            </div>
          </button>
