...
class Curator:
    def __init__(self) -> None:
        self.relevance_threshold = 0.75  # Fixed initialization of class attribute
                ...
                await websocket_manager.send_status_update(
                    ...
                    result={
                        ...
                        "doc_counts": {
                            ...
                            "revenue": doc_counts.get('revenue_data', {"initial": 0, "kept": 0})
                        }
                    }
                )
